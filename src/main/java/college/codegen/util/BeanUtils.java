...
public class BeanUtils {
    ...
    public static <T> T copyProperties(Object tableInfo, Class<T> table) {
        try {
            T item = table.newInstance();
            org.springframework.beans.BeanUtils.copyProperties(tableInfo, item);
            return item;
